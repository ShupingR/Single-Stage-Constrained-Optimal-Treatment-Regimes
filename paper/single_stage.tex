...
\begin{abstract}
Precision medicine aims to improve diseases interventions by taking the variability of patients into account. In chronic conditions, clinicians often need to make a sequence of decisions for patients during the process of diseases. The sequential decision making problem in precision medicine is mathematically formalized as dynamic treatment regimes, which are sequences of decision rules, one for each decision point, that take patient cumulative information as input and output recommended treatment assignment. In most cases, a regime is considered to be optimal if it optimizes the expected value of a single scalar potential outcome in a population of interest. However, this current framework neglects the practically clinical need of balancing several competing outcomes, such as, treatment effectiveness, side effect burden, cost etc. To handle the trade-off among multiple competing outcomes, we develop a new framework where the optimal regime optimizes the primary potential outcome of interest, subject to constraints on secondary potential outcomes of interest. Estimation and inference for such constrained optimal regimes are carried out. Simulation results are presented using efficient frontier plots. Asymptotic normality of the estimator is proven.
\end{abstract}
...
\begin{table}[!htbp]
	\centering
	{\tt
		\input{/Users/shuping.ruan/Dropbox/6_Graduate/sim/one-stage-sim-new/one-stage-sim-round-2/result_1.tex}
	}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=.9\linewidth]{/Users/shuping.ruan/Dropbox/6_Graduate/sim/one-stage-sim-new/efficient_plot1.pdf}
...
\begin{table}[!htbp]
	\centering
	{\tt
		\input{/Users/shuping.ruan/Dropbox/6_Graduate/sim/one-stage-sim-new/result_2.tex}
	}
	\caption {Simulation Result for Setting 2}
\end{table} 
\begin{figure}[!htb]
	\centering
	\includegraphics[width=.9\linewidth]{/Users/shuping.ruan/Dropbox/6_Graduate/sim/one-stage-sim-new/efficient_plot2.pdf}
...
\begin{table}[!htbp]
	\centering
	{\tt
		\input{/Users/shuping.ruan/Dropbox/6_Graduate/sim/one-stage-sim-new/result_3.tex}
	}
	\caption {Simulation Result for Setting 3}
\end{table} 
\begin{figure}[!htb]
	\centering
	\includegraphics[width=.9\linewidth]{/Users/shuping.ruan/Dropbox/6_Graduate/sim/one-stage-sim-new/efficient_plot3.pdf}
...
\begin{table}[!htbp]
	\centering
	{\tt
		\input{/Users/shuping.ruan/Dropbox/6_Graduate/sim/one-stage-sim-new/result_4.tex}
	}
	\caption {Simulation Result for Setting 4}
\end{table} 
\begin{figure}[!htb]
	\centering
	\includegraphics[width=.9\linewidth]{/Users/shuping.ruan/Dropbox/6_Graduate/sim/one-stage-sim-new/efficient_plot4.pdf}
...
\begin{table}[!htbp]
	\centering
	{\tt
		\input{/Users/shuping.ruan/Dropbox/6_Graduate/sim/one-stage-sim-new/result_5.tex}
	}
	\caption {Simulation Result for Setting 5}
\end{table} 
\begin{figure}[!htb]
	\centering
	\includegraphics[width=.9\linewidth]{/Users/shuping.ruan/Dropbox/6_Graduate/sim/one-stage-sim-new/efficient_plot5.pdf}
...
\begin{table}[!htbp]
	\centering
	{\tt
		\input{/Users/shuping.ruan/Dropbox/6_Graduate/sim/one-stage-sim-new/result_6.tex}
	}
	\caption {Simulation Result for Setting 6}
\end{table} 
\begin{figure}[!htb]
	\centering
	\includegraphics[width=.9\linewidth]{/Users/shuping.ruan/Dropbox/6_Graduate/sim/one-stage-sim-new/efficient_plot6.pdf}
...
\begin{table}[!htbp]
	\centering
	{\tt
		\input{/Users/shuping.ruan/Dropbox/6_Graduate/sim/one-stage-sim-new/result_7.tex}
	}
	\caption {Simulation Result for Setting 7}
\end{table} 
\begin{figure}[!htb]
	\centering
	\includegraphics[width=.9\linewidth]{/Users/shuping.ruan/Dropbox/6_Graduate/sim/one-stage-sim-new/efficient_plot7.pdf}
...
\begin{table}[!htbp]
	\centering
	{\tt
		\input{/Users/shuping.ruan/Dropbox/6_Graduate/sim/one-stage-sim-new/result_8.tex}
	}
	\caption {Simulation Result for Setting 8}
\end{table} 
\begin{figure}[!htb]
	\centering
	\includegraphics[width=.9\linewidth]{/Users/shuping.ruan/Dropbox/6_Graduate/sim/one-stage-sim-new/efficient_plot8.pdf}
...
\begin{table}[!htbp]
	\centering
	{\tt
		\input{/Users/shuping.ruan/Dropbox/6_Graduate/sim/one-stage-sim-new/result_9.tex}
	}
	\caption {Simulation Result for Setting 9}
\end{table} 
\begin{figure}[!htb]
	\centering
	\includegraphics[width=.9\linewidth]{/Users/shuping.ruan/Dropbox/6_Graduate/sim/one-stage-sim-new/efficient_plot9.pdf}
